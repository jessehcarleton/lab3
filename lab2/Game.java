...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        //new room
        Room cellar  = new Room("in a dusty cellar below the library");
        ...
        /*outside.setExit(null, theater, lab, pub);
    ...
    private boolean back() 
    {
        if (prevRooms.isEmpty()){
            System.out.println("Nowhere to go back");
            return false;
        }else{
            currentRoom = prevRooms.pop();
            System.out.println("You've gone back");
